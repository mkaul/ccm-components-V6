/**
 * @overview game_wakener is a little game implemented in ccm
...
ccm.component( /** @lends ccm.components.game_wakener */ {
   ...
   * @type {ccm.components.game_wakener.types.config}
   */
  config: {
    ...
    lang:  [ ccm.instance, 'http://mkaul.github.io/ccm-components/resources/lang/lang.js', { store: [ ccm.store, '../game_wakener/game_wakener_lang.json' ] } ]
  ...
  /**
   * @namespace ccm.components.game_wakener
   */

  /**
   * @namespace ccm.components.game_wakener.types
   */
