...
ccm.component( {
  ...
  config: {
    ...
    key:   'themen',
    html:  [ ccm.load, '../mass_document_view/mass_document_view_html.json' ],     // schema
    style:  [ ccm.load, '../mass_document_view/mass_document_view.css' ],     // layout
    store: [ ccm.store, '../mass_document_view/mass_document_view.json' ], // values for schema
